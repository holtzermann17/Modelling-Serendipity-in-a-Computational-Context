...
\vspace{-.2cm}
\noindent\begin{tabularx}{.98\textwidth}{|Y|Y|c}  \cline{1-2}
...
\noindent\begin{tabularx}{.98\textwidth}{|Y|Y|Y|Y|Y|c}  \cline{1-5}
preparation & incubation & insight & evaluation & {elaboration} & (6) \\
\end{tabularx}\offinterlineskip

\noindent\begin{tabularx}{.98\textwidth}{|Y|Y|Y|Y|Y|Y|c}  \cline{1-6}
...
\noindent\begin{tabularx}{.98\textwidth}{|Y|Y|Y|Y|Y|Y|c}  \cline{1-6}
\multicolumn{2}{|p{.279\textwidth}|}{\begin{minipage}{.2787\textwidth}
